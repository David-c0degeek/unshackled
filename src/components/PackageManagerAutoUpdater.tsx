...
export function PackageManagerAutoUpdater(t0) {
  ...
  const updateCommand = packageManager === "homebrew" ? "brew upgrade unshackled" : packageManager === "winget" ? "winget upgrade Unshackled" : packageManager === "apk" ? "apk upgrade unshackled" : "your package manager update command";
  let t4;
  if ($[3] !== verbose) {
