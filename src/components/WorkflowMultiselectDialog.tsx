...
export function WorkflowMultiselectDialog(t0) {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box><Text dimColor={true}>More workflow examples (issue triage, CI fixes, etc.) at:{" "}<Link url="https://github.com/paoloanzn/unshackled-action/blob/main/examples/">https://github.com/paoloanzn/unshackled-action/blob/main/examples/</Link></Text></Box>;
    $[4] = t4;
  } else {
    t4 = $[4];
  }
