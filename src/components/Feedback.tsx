...
const GITHUB_ISSUES_REPO_URL = "external" === 'ant' ? 'https://github.com/paoloanzn/unshackled-internal/issues' : 'https://github.com/paoloanzn/unshackled/issues';
type Props = {
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Unshackled&apos;s functionality (eg. to reduce the risk of bugs
