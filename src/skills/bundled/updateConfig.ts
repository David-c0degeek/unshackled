...
Hooks run commands at specific points in Unshackled's lifecycle.
...
Modify Unshackled configuration by updating settings.json files.
...
6. **Use --debug** - Run \`unshackled --debug\` to see hook execution logs
`
