...
const NPM_DEPRECATION_MESSAGE = 'Unshackled has switched from npm to native installer. Run `unshackled install` or see https://docs.anthropic.com/en/docs/claude-code/getting-started for more options.';
