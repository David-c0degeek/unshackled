...
export const DESCRIPTION = 'Get or set Unshackled configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Unshackled configuration settings.

  View or change Unshackled settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
