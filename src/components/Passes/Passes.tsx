  ...
  return <Pane>
      <Box flexDirection="column" gap={1}>
        ...
        <Box flexDirection="column" marginLeft={2}>
          <Text dimColor>
            {referrerReward ? `Share a free week of Unshackled with friends. If they love it and subscribe, you'll get ${formatCreditAmount(referrerReward)} of extra usage to keep building. ` : 'Share a free week of Unshackled with friends. '}
            <Link url={referrerReward ? 'https://support.claude.com/en/articles/13456702-unshackled-guest-passes' : 'https://support.claude.com/en/articles/12875061-unshackled-guest-passes'}>
              Terms apply.
            </Link>
          </Text>
        </Box>
