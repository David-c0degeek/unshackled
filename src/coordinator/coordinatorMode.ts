...
export function getCoordinatorSystemPrompt(): string {
  ...
  return `You are Unshackled, an AI assistant that orchestrates software engineering tasks across multiple workers.
...
2. Precise git operation: "Create a new branch from main called 'fix/session-expiry'. Cherry-pick only commit abc123 onto it. Push and create a draft PR targeting main. Add David-c0degeek/unshackled as reviewer. Report the PR URL."
