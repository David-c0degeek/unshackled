 ...
 *
 * Used by both `unshackled remote-control` (empty session so the user has somewhere to
 ...
 * explicit client action. Both `unshackled remote-control` (standalone bridge) and the
