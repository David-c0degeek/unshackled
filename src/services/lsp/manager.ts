 ...
 * Initialized during Unshackled startup.
 */
 ...
 * asynchronously during Unshackled startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Unshackled startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/David-c0degeek/unshackled/issues/15521:
 ...
 *
 * This should be called during Unshackled shutdown. Stops all running LSP servers
