...
/**
 * The JSON Schema URL for Unshackled settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/unshackled-settings.json
 */
export const CLAUDE_CODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/unshackled-settings.json'
