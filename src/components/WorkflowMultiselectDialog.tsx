...
const WORKFLOWS: WorkflowOption[] = [{
  ...
  label: '@Unshackled - Tag @claude in issues and PR comments'
}, {
  value: 'claude-review' as const,
  label: 'Unshackled Review - Automated code review on new PRs'
}];
...
export function WorkflowMultiselectDialog(t0) {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box><Text dimColor={true}>More workflow examples (issue triage, CI fixes, etc.) at:{" "}<Link url="https://github.com/David-c0degeek/unshackled-action/blob/main/examples/">https://github.com/David-c0degeek/unshackled-action/blob/main/examples/</Link></Text></Box>;
    $[4] = t4;
  } else {
    t4 = $[4];
  }
